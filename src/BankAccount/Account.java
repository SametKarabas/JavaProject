...
public class Account {
   ...
   //--------------------------------------------------------------------------------------------------
    ...
    public static String transferOtherUser(Users sendingUser,Users receivingUser,int transferAmount){
        if (transferAmount>sendingUser.amountAccaount1){
            return "Sender is poor lol :)";
        }
        else if (transferAmount<sendingUser.amountAccaount1){
            transferAmount=transferAmount-(transferAmount*2/100);
            sendingUser.amountAccaount1-=transferAmount;
            receivingUser.amountAccaount1+=transferAmount;
        }
    ...
    public static String transferToOwnAccount(Users object,int transferAmount){
        if (transferAmount>object.amountAccaount1){
            return "You need more money dude";
        }
        else if (transferAmount<object.amountAccaount1){
            transferAmount=transferAmount-(transferAmount/100);
            object.amountAccaount1-=transferAmount;
